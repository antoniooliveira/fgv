<div class="_view">
    ...
    <dl>
        ...
        <dd>
            <?php echo h($perfis['Perfi']['id']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('Nome'); ?></dt>
        <dd>
            <?php echo h($perfis['Perfi']['nome']); ?>
            &nbsp;
        </dd>
    </dl>
</div>
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link('<i class="fa fa-sort-amount-desc fa-lg pull-right"></i> '.__('Listar Perfis'), array('action' => 'index'), array('escape'=>false)); ?> </li>
...
<div class="related">
    ...
    <?php if (!empty($perfis)): ?>
        <table cellpadding = "0" cellspacing = "0">
            ...
            <?php foreach ($perfis['Usuario'] as $usuario): ?>
                <tr>
